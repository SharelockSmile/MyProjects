...
class WebSite extends BaseService implements IWebSite
{
     ...
     */
    function updateWebSite($title, $logo, $web_desc, $key_words, $web_icp, $web_style_pc, $web_style_admin, $web_qrcode, $web_url, $web_phone, $web_email, $web_qq, $web_weixin, $web_address, $web_status, $wap_status, $third_count, $close_reason)
    {
        $data = array(
            'title' => $title,
            'logo' => $logo,
