...
class PublicAction extends Action
{
        ...
        function checklogin()
        {
            $response = "{'success':true}";	
                ...
                if (empty($_POST['user']))
                {
                        $response = "{errors:[{id:'user', msg:'帐号错误'}]}";
                        echo $response;
                        exit();
//                        $this->error('帐号错误！');
...
//                if ($_SESSION['verify'] != md5($_POST['chknumber']))
//                {
...
//                }
                ...
                if (empty($authInfo))
                {
                        $response = "{errors:[{id:'user', msg:'账号不存在或者被禁用'}]}";
                        echo $response;
                        exit();
//                        $this->error('账号不存在或者被禁用!');
                } else
                {
                        ...
                        {
                                $response = "{errors:[{id:'pass', msg:'账号密码错误'},{id:'user', msg:'账号密码错误'}]}";
                                echo $response;
                                exit();
//                                $this->error('账号密码错误!');
                        }
